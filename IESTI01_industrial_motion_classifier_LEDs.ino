...
/* Includes ---------------------------------------------------------------- */
#include <IESTI01-industrial-motion-classifier_inferencing.h>
...
void loop()
{
    ...
    for (size_t ix = 0; ix < EI_CLASSIFIER_LABEL_COUNT; ix++) {
        ...
        if ((result.classification[ix].label == "ON_MIN") && (result.classification[ix].value > 0.90)){
          digitalWrite(LEDR, HIGH);
          digitalWrite(LEDG, HIGH);
          digitalWrite(LEDB, HIGH);
          ...
          if ((result.classification[ix].label == "ON_MED") && (result.classification[ix].value > 0.90)){
            digitalWrite(LEDR, HIGH);
            digitalWrite(LEDG, HIGH);
            digitalWrite(LEDB, HIGH);
            ...
            if ((result.classification[ix].label == "ON_MAX") && (result.classification[ix].value > 0.90)){
              digitalWrite(LEDR, HIGH);
              digitalWrite(LEDG, HIGH);
              digitalWrite(LEDB, HIGH);
              digitalWrite(LEDR, LOW);
              ...
              if ((result.classification[ix].label == "OFF") && (result.classification[ix].value > 0.90)){
                digitalWrite(LEDR, HIGH);
                digitalWrite(LEDG, HIGH);
                digitalWrite(LEDB, HIGH);
              }
